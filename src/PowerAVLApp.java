/**
PowerAVLApp to read in CSV file and store data items within an AVL Tree
@author Mahmoodah Jaffer - JFFMAH001
@since 10 March 2019
*/

/**
	PowerAVLApp is an application that returns the power and voltage of a specified date/time given by user according to the data in the file
	...
	voltage and power for each date/time is given.The data is stored in an AVL Tree as opposed to a Binary Search Tree.
*/
import java.io.*;
	...
	*/
	...
	public static void main (String [] args) throws IOException
	{
		...
		/**
			...
			AVL Tree to store each element
			@param filename String
			@return powerdata AVLTree of type AVLTree
		...
		*/
		...
		public static AVLTree fileData (String filename) throws FileNotFoundException, IOException
		{
			...
			while (line!=null)
			{
				...
				powerdata.insert(new PowerStation(datetime,power,voltage)); //Powerstation object will store the datetime, power and voltage in node pf AVL Tree
		...
		/**
			Method searches for datetime given using the find function in the class AVLTree and returns the corresponding voltage and power 
		...
		*/
		...
		/**
			Method printAllDateTimes dispalys all elements of the AVLTree using the display function in the AVLTree class
			@exception IOException
			@see IOException
		*/
